          ...
          <Card className="shadow-2xl shadow-primary/8 border-border/50">
            ...
            <CardContent className="pt-4">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full h-11 text-sm font-medium gap-3 mb-4"
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phoneNumber" className="text-sm font-medium">Phone <span className="text-muted-foreground font-normal">(Optional)</span></Label>
                    <PhoneInput
                      id="phoneNumber"
                ...
                {formData.password && (
                  <div className="space-y-1.5">
                    ...
                    <p className={`text-xs ${pwStrength.score <= 1 ? "text-red-500" : pwStrength.score === 2 ? "text-orange-500" : pwStrength.score === 3 ? "text-yellow-600" : "text-emerald-600"}`}>
                      {pwStrength.label} — Use uppercase, numbers & symbols for a stronger password
                    </p>
                  </div>
                )}
